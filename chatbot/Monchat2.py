...
data['category'] = data['category'].str.strip().str.replace('"', '').str.replace('“', '').str.replace('”', '')
print(data[data['category'] == 'Gestion des rendez-vous'])
...
print(category_counts) #**7. Learning Curve**
